...
describe("useMessagesByTopic", () => {
    it("initializes with an empty array per topic", async () => {
        const { result } = renderHook(({ topics, historySize }) => PanelAPI.useMessagesByTopic({ topics, historySize }), {
    ...
    it("add messages to their respective arrays", () => {
        ...
        const { result, rerender } = renderHook(({ topics, historySize }) => PanelAPI.useMessagesByTopic({ topics, historySize }), {
