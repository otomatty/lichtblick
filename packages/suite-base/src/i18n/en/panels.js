...
export const panels = {
    ...
    ROSDiagnosticsDetailDescription: "Display ROS DiagnosticArray messages for a specific hardware_id.",
    ...
    studioPlaybackPerformanceDescription: "Display playback and data-streaming performance statistics.",
    tab: "Tab",
    ...
    userScriptsDescription: "Write custom data transformations in TypeScript. Previously known as Node Playground.",
