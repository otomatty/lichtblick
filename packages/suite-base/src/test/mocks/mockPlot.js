...
export const fixture = {
    ...
    activeData: {
        ...
        currentTime: _.maxBy([...locationMessages, ...otherStateMessages], (msg) => toSec(msg.header.stamp))?.header.stamp,
        isPlaying: false,
        speed: 0.2,
    },
    frame: {
        ...
        "/some_topic/location_shuffled": _.shuffle(locationMessages.map((message) => ({
