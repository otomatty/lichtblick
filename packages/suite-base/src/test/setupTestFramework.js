...
import { setupMockSendNotification, mockSendNotification, mockSetNotificationHandler, } from "@lichtblick/suite-base/test/MockSendNotification";
...
afterEach(() => {
    ...
    if (calls.length > 0) {
        ...
        throw new Error(`console.error was called in the test.\n\n
...
afterEach(() => {
    ...
    if (calls.length > 0) {
        ...
        throw new Error(`console.warn was called in the test.\n\n
...
afterEach(async () => {
    if (mockSendNotification.mock.calls.length > 0) {
        ...
        throw new Error(`sendNotification has been called during this test (call sendNotification.expectCalledDuringTest(); at the end of your test if you expect this): ${JSON.stringify(calls)}`);
    }
});
