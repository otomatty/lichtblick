...
export default function usePublisher({ topic, schemaName, datatypes, name, }) {
    const [id] = useState(() => uuidv4());
    const canPublish = useMessagePipeline((context) => context.playerState.capabilities.includes(PLAYER_CAPABILITIES.advertise));
