...
const selectCanSeek = (ctx) => ctx.playerState.capabilities.includes(PLAYER_CAPABILITIES.playbackControl);
const selectCurrentTime = (ctx) => ctx.playerState.activeData?.currentTime;
const selectUrlState = (ctx) => ctx.playerState.urlState;
 ...
 */
export function useStateToURLSynchronization() {
    ...
    useEffect(() => {
        ...
        updateUrl({
            ...
            dsParamsArray: _.pickBy(stablePlayerUrlState.parameters, _.isArray),
        });
