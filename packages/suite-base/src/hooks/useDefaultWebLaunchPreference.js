...
const selectHasUrlState = (ctx) => ctx.playerState.urlState != undefined;
export function useDefaultWebLaunchPreference() {
    const hasUrlState = useMessagePipeline(selectHasUrlState);
    const [launchPreference, setLaunchPreference] = useSessionStorageValue(AppSetting.LAUNCH_PREFERENCE);
