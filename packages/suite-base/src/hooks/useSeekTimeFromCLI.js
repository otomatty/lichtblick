...
const useSeekTimeFromCLI = () => {
    const { playerState: { presence }, seekPlayback, } = useMessagePipelineGetter()();
    ...
    useEffect(() => {
        ...
        if (parsedTime == undefined) {
            ...
            enqueueSnackbar("Invalid time format using 'time' parameter on CLI. Please check and try again.", { variant: "warning" });
            return;
        }
