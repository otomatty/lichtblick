 ...
 * as player alerts
 */
export class TopicAliasingPlayer {
    #player;
    #inputs;
    #aliasedSubscriptions;
    #subscriptions = [];
    // True if no aliases are active and we can pass calls directly through to the
    // underlying player.
    #skipAliasing;
    #stateProcessorFactory = new StateProcessorFactory();
    ...
    setAliasFunctions(aliasFunctions) {
    ...
    setPlaybackSpeed(speedFraction) {
