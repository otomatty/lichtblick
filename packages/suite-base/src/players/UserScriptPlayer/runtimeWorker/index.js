...
import { processMessage, registerScript, } from "@lichtblick/suite-base/players/UserScriptPlayer/runtimeWorker/registry";
...
global.onconnect = (e) => {
    ...
    global.onunhandledrejection = (event) => {
        void rpc.send("error", String(event.reason instanceof Error ? event.reason.message : event.reason));
    };
