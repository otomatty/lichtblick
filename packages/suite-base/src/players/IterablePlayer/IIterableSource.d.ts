...
import { PlayerAlert, Topic, TopicSelection, TopicStats } from "@lichtblick/suite-base/players/types";
...
export interface IIterableSource {
     ...
     */
    messageIterator(args: Immutable<MessageIteratorArgs>): AsyncIterableIterator<Readonly<IteratorResult>>;
    /**
