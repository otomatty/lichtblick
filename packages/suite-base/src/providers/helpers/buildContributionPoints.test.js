...
describe("buildContributionPoints", () => {
    ...
    `;
        ...
        expect(result.panels[panelId]).toEqual(expect.objectContaining({
    ...
    `;
        ...
        expect(result.panels[panelId]).toBeDefined();
        // 警告ログが出力されることを検証
        expect(logWarnMock).toHaveBeenCalledWith(expect.stringContaining(`Panel ${panelId} is already registered`));
        // クリーンアップ
        delete globalThis.panel;
    ...
    it("should register a message converter", () => {
        ...
        globalThis.messageConverter = messageConverter;
    ...
    `;
        ...
        delete globalThis.messageConverter;
    });
    /**
     * パネル設定統合のテスト
     *
    ...
    `;
        ...
        expect(result.panelSettings.panelSettingsA[messageConverter.fromSchemaName]).toEqual(panelSettingsA);
        expect(result.panelSettings.panelSettingsB).toHaveProperty(messageConverter.fromSchemaName);
        expect(result.panelSettings.panelSettingsB[messageConverter.fromSchemaName]).toEqual(panelSettingsB);
        delete globalThis.messageConverter;
    });
    /**
     * トピックエイリアス登録のテスト
    ...
    it("registers topic aliases correctly", () => {
        ...
        const aliasFunction = jest.fn();
        globalThis.topicAliasFunction = aliasFunction;
    ...
    `;
        ...
        delete globalThis.topicAliasFunction;
    });
});
