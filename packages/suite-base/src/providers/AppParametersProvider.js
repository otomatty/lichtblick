...
import { AppParametersContext, } from "@lichtblick/suite-base/context/AppParametersContext";
/**
 ...
 * ```
 */
export default function AppParametersProvider({ children, appParameters = {}, }) {
    // パラメータをメモ化して不要な再レンダリングを防ぐ
    const parameters = useMemo(() => appParameters, [appParameters]);
    return (_jsx(AppParametersContext.Provider, { value: parameters, children: children }));
}
