...
describe("layout reducers", () => {
    describe("adds panel to a layout", () => {
        it("adds panel to main app layout", () => {
            ...
            const firstStr = layout.first;
            const secondStr = layout.second;
        ...
        it("adds panel to empty Tab layout", () => {
            ...
            const tabs = configById["Tab!a"].tabs;
    ...
    describe("drops panel into a layout", () => {
        ...
        it("drops Tab panel into app layout", () => {
            ...
            const { activeTabIdx, tabs } = configById[layout.second];
        ...
        it("drops panel into nested Tab layout", () => {
            ...
            const tabBTabs = configById["Tab!b"].tabs;
            ...
            expect(configById[tabBTabs[0].layout.second]).toEqual({
                foo: "bar",
            });
        });
    });
    describe("moves tabs", () => {
        ...
        it("moves tabs between Tab panels", () => {
            const layout = { first: "Tab!a", second: "Tab!b", direction: "row" };
            let panels = {
                ...emptyLayout,
                layout,
                configById: {
    ...
    it("closes a panel in multi-panel layout", () => {
        const layout = { first: "Audio!a", second: "Audio!b", direction: "row" };
        let panels = {
            ...emptyLayout,
            layout,
    ...
    describe("creates Tab panels from existing panels correctly", () => {
        ...
        it("will group selected panels into a Tab panel", () => {
            let panels = { ...emptyLayout, ...regularLayoutPayload };
            panels = panelsReducer(panels, {
        ...
        it("will group selected panels into a Tab panel, even when a selected panel is nested", () => {
            let panels = { ...emptyLayout, ...nestedLayoutPayload };
            panels = panelsReducer(panels, {
                type: "CREATE_TAB_PANEL",
    ...
    describe("panel toolbar actions", () => {
        ...
        it("can split Tab panel", () => {
            ...
            const newAudioId = configById[newTabId].tabs[0].layout;
        ...
        it("can split panel inside Tab panel", () => {
            ...
            const { layout, configById } = panels;
            expect(layout).toEqual("Tab!a");
            const tabLayout = configById["Tab!a"].tabs[0]
                .layout;
            const newAudioId = tabLayout.second;
            expect(getPanelTypeFromId(newAudioId)).toEqual("Audio");
            expect(newAudioId).not.toEqual("Audio!a");
            expect(configById).toEqual({
                "Tab!a": {
        ...
        it("can split outer Tab of two nested Tabs", () => {
            ...
            const { layout, configById } = panels;
            const newOuterTabId = layout.second;
            ...
            const newInnerTabId = configById[newOuterTabId].tabs[0].layout;
            ...
            const newAudioId = configById[newInnerTabId].tabs[0].layout;
            expect(getPanelTypeFromId(newAudioId)).toEqual("Audio");
            expect(newAudioId).not.toEqual("Audio!a");
            expect(configById).toEqual({
                "Tab!a": {
        ...
        it("can split inner Tab of two nested Tabs", () => {
            ...
            const { layout, configById } = panels;
            expect(layout).toEqual("Tab!a");
            const outerTabLayout = configById["Tab!a"].tabs[0]
                .layout;
            const newTabId = outerTabLayout.second;
        ...
        it("can swap panel for a Tab panel", () => {
            ...
            const tabLayout = configById[layout].tabs[0].layout;
        ...
        it("can swap panel inside a Tab", () => {
            ...
            const { layout, configById } = panels;
            expect(layout).toEqual("Tab!a");
            const tabLayout = configById["Tab!a"].tabs[0].layout;
            expect(getPanelTypeFromId(tabLayout)).toEqual("RawMessages");
            expect(configById[tabLayout]).toEqual(rawMessagesConfig);
        });
    });
    ...
    describe("handles dragging panels", () => {
        ...
        it("handles drags in multi-panel layouts - invalid position", () => {
            ...
            let panels = { ...emptyLayout, layout: originalLayout };
            panels = panelsReducer(panels, {
                type: "START_DRAG",
                payload: { sourceTabId: undefined, path: ["first"] },
            });
