...
function renderTest({ mockLayoutManager, mockUserProfile, mockAppParameters = {}, }) {
    ...
    const { result } = renderHook(() => {
        ...
        wrapper: function Wrapper({ children }) {
            ...
            return (_jsx(AppParametersProvider, { appParameters: mockAppParameters, children: _jsx(SnackbarProvider, { children: _jsx(LayoutManagerContext.Provider, { value: mockLayoutManager, children: _jsx(UserProfileStorageContext.Provider, { value: mockUserProfile, children: _jsxs(CurrentLayoutProvider, { loaders: [], children: [children, _jsx(CurrentLayoutSyncAdapter, {})] }) }) }) }) }));
        },
    });
    return { result, all };
}
describe("CurrentLayoutProvider", () => {
    ...
    it("should show a message to the user if the defaultLayout from app parameter is not found", async () => {
        ...
        expect(enqueueSnackbar).toHaveBeenCalledWith(`The layout '${mockAppParameters.defaultLayout}' specified in the app parameters does not exist.`, { variant: "warning" });
    });
});
