...
export function getRotationTo(src, dest) {
...
export function isZeroLength(vec) {
    return vec.lengthSq() < 1e-6 * 1e-6;
}
export function approxEquals(a, b, epsilon = 0.00001) {
    return Math.abs(a - b) < epsilon;
}
export function vec3TupleApproxEquals(a, b, epsilon = 0.00001) {
    return (approxEquals(a[0], b[0], epsilon) &&
