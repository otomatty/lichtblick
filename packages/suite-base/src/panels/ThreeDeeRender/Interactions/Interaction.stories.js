...
function PanelSetupWithData(props) {
    const { children, title } = props;
    return (_jsx(PanelSetup, { omitDragAndDrop: true, style: { width: "auto", height: "auto" }, fixture: {
            topics: [],
            datatypes: new Map(),
            frame: {},
            globalVariables: {
        ...
        }, children: _jsxs("div", { children: [_jsx("p", { children: title }), children] }) }));
}
export default {
    ...
    decorators: [
        (Story) => {
            ...
            return (_jsx(Stack, { fullHeight: true, fullWidth: true, direction: "row", flexWrap: "wrap", gap: 4, padding: 2, style: { background: theme.palette.background.paper }, children: _jsx(Story, {}) }));
        },
    ],
};
export const Default = {
    render: () => (_jsxs(_Fragment, { children: [_jsx(PanelSetupWithData, { title: "Default without clicked object", children: _jsx(Interactions, { ...sharedProps, selectedObject: undefined, interactionsTabType: OBJECT_TAB_TYPE }) }), _jsx(PanelSetupWithData, { title: "With interactionData", children: _jsx(Interactions, { ...sharedProps }) })] })),
};
export const PointCloud = {
    render: () => {
        ...
        return (_jsxs(_Fragment, { children: [_jsx(PanelSetupWithData, { title: "default with point color", children: _jsx(Interactions, { ...sharedProps, selectedObject: {
                            instanceIndex: 0,
                            object: {
                                ...cloud1,
                                type: 102,
                        ...
                        } }) }), _jsx(PanelSetupWithData, { title: "with additional fields", children: _jsx(Interactions, { ...sharedProps, selectedObject: {
                            instanceIndex: 0,
                            object: {
                                ...cloud2,
                                type: 102,
