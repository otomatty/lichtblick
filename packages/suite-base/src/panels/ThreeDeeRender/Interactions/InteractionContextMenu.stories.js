...
export default {
    ...
    decorators: [
        (Story) => {
            ...
            return (_jsx("div", { style: { height: "100vh", width: "100vh", background: theme.palette.background.default }, children: _jsx(Story, {}) }));
        },
    ],
};
export const Light = {
    render: () => _jsx(InteractionContextMenu, { onClose: () => { }, ...sharedProps }),
