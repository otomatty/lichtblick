...
export class Input extends EventEmitter {
    ...
    #updateCursorCoords(event) {
        ...
        tempVec2.set((offsetX / this.canvasSize.width) * 2 - 1, -((offsetY / this.canvasSize.height) * 2 - 1)), this.getCamera());
        this.#worldSpaceCursorCoords =
            this.#raycaster.ray.intersectPlane(XY_PLANE, this.#worldSpaceCursorCoords ?? new THREE.Vector3()) ?? undefined;
    }
}
function innerSize(node) {
