...
import { LineType, PointsAnnotationType, } from "@foxglove/schemas";
...
const ImageWith3D = (initialConfig) => {
    const topics = [
...
export const ImageOnlyModeOffWithAutoSelectedTopics = {
    render: ImageWith3D,
    args: { imageTopic: undefined, calibrationTopic: undefined },
};
export const ImageOnlyModeOffWithAutoSelectedCalibration = {
    render: ImageWith3D,
...
function makeSceneUpdate({ topic, frameId, }) {
