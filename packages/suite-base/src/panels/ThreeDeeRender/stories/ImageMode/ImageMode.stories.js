...
import { makeCompressedImageAndCalibration, makeRawImageAndCalibration, } from "@lichtblick/suite-base/panels/ThreeDeeRender/stories/ImageMode/imageCommon";
...
const ImageModeRosImage = ({ imageType }) => {
    const topics = [
    ...
    return (_jsx(PanelSetup, { fixture: fixture, children: _jsx(ImagePanel, { overrideConfig: {
...
export const ImageModeRosRawImage = {
    render: ImageModeRosImage,
    args: { imageType: "raw" },
};
export const ImageModeRosPngImage = {
    render: ImageModeRosImage,
    args: { imageType: "png" },
};
const ImageModeFoxgloveImage = ({ imageType = "raw", rotation, onDownloadImage, flipHorizontal = false, flipVertical = false, minValue, maxValue, }) => {
    const topics = [
        { name: "/cam1/info", schemaName: "foxglove.CameraCalibration" },
        { name: "/cam2/info", schemaName: "foxglove.CameraCalibration" },
        { name: "/cam1/png", schemaName: "foxglove.CompressedImage" },
    ...
    return (_jsx(PanelSetup, { fixture: fixture, children: _jsx(ImagePanel, { onDownloadImage: onDownloadImage, overrideConfig: {
                ...ImagePanel.defaultConfig,
                followTf: undefined,
                scene: {
                    transforms: {
...
export const ImageModeFoxgloveRawImage = {
    render: ImageModeFoxgloveImage,
    args: { imageType: "raw" },
};
export const ImageModeFoxglovePngImage = {
    render: ImageModeFoxgloveImage,
    args: { imageType: "png" },
};
export const DownloadRawImage = {
    render: function Story(args) {
        const [src, setSrc] = useState();
        const [filename, setFilename] = useState();
        const onDownloadImage = useCallback((blob, fileName) => {
            setSrc(URL.createObjectURL(blob));
            setFilename(fileName);
        }, []);
        return (_jsxs(Stack, { direction: "row", fullHeight: true, children: [_jsx(Stack, { style: { width: "50%" }, children: _jsx(ImageModeFoxgloveImage, { ...args, onDownloadImage: onDownloadImage }) }), _jsxs(Stack, { style: { width: "50%" }, zeroMinWidth: true, children: [_jsx("div", { children: filename == undefined ? "Not downloaded" : `Downloaded image: ${filename}` }), _jsx("img", { src: src, style: { imageRendering: "pixelated", border: "1px solid red" } })] })] }));
    },
    args: { imageType: "raw" },
    play: async () => {
...
const InvalidPinholeCamera = () => {
    ...
    return (_jsx(PanelSetup, { fixture: fixture, includeSettings: true, children: _jsx(ImagePanel, { overrideConfig: {
                ...ImagePanel.defaultConfig,
                imageMode: {
                    calibrationTopic: "calibration",
                    imageTopic: "camera",
...
export const ImageModeInvalidCameraCalibration = {
    render: () => _jsx(InvalidPinholeCamera, {}),
    play: async () => {
        const errorIcon = await screen.findByTestId("ErrorIcon");
        await userEvent.hover(errorIcon);
    },
};
export const UnsupportedEncodingError = {
    render: function Story() {
        const imageTopic = "camera";
        const topics = [{ name: imageTopic, schemaName: "foxglove.RawImage" }];
        const cameraMessage = {
            topic: imageTopic,
            receiveTime: { sec: 10, nsec: 0 },
            message: {
        ...
        return (_jsx(PanelSetup, { fixture: fixture, includeSettings: true, children: _jsx(ImagePanel, { overrideConfig: { ...ImagePanel.defaultConfig, imageMode: { imageTopic } } }) }));
    },
    play: async () => {
...
export const DecompressionError = {
    render: function Story() {
        const imageTopic = "camera";
        const topics = [{ name: imageTopic, schemaName: "foxglove.CompressedImage" }];
        const cameraMessage = {
            topic: imageTopic,
            receiveTime: { sec: 10, nsec: 0 },
            message: {
...
export const LargeImage = {
    render: function Story() {
        const imageTopic = "camera";
        const topics = useMemo(() => [{ name: imageTopic, schemaName: "foxglove.CompressedImage" }], []);
        const fixture = useAsync(async () => {
            const width = 1000;
            const height = 600;
        ...
        return (_jsx(PanelSetup, { fixture: fixture.value, children: _jsx(ImagePanel, { overrideConfig: {
                    ...ImagePanel.defaultConfig,
                    imageMode: { imageTopic },
                } }) }));
    },
};
function makeYUYV(width, height) {
...
function makeUYVY(width, height) {
...
export const YUYV = {
    render: function Story() {
        const imageTopic = "camera";
        const topics = useMemo(() => [{ name: imageTopic, schemaName: "foxglove.RawImage" }], []);
        const width = 200;
        const height = 150;
        const cameraMessage = {
            topic: imageTopic,
...
export const RationalPolynomialDistortion = {
    render: function Story() {
        const imageTopic = "camera";
...
const ImageModeEmptyLayout = ({ type, }) => {
    let fixture;
    let calibrationTopic = "calibration";
    switch (type) {
        case "no-topics":
            fixture = {
                topics: [],
...
export const ImageModeEmptyNoTopics = {
    render: ImageModeEmptyLayout,
    args: { type: "no-topics" },
};
export const ImageModeEmptyNoImageTopics = {
    render: ImageModeEmptyLayout,
    args: { type: "no-topics" },
};
export const ImageModeEmptyNoMessages = {
    render: ImageModeEmptyLayout,
    args: { type: "no-messages" },
};
// when calibration == "None", then we display an empty state when only the image topic does not exist
export const ImageModeEmptyOnlyImageTopicDNE = {
    render: ImageModeEmptyLayout,
