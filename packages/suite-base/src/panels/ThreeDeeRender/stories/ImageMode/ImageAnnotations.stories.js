...
const AnnotationsStory = (args = {}) => {
    ...
    return (_jsx("div", { style: { width: 1200, height: 900, flexShrink: 0 }, children: _jsx(PanelSetup, { fixture: fixture, children: _jsx(ImagePanel, { debugPicking: debugPicking, overrideConfig: {
...
export const AnnotationsPicking = {
    render: AnnotationsStory,
    args: {
        debugPicking: true,
    },
...
export const AnnotationsWithoutCalibration = {
    render: AnnotationsStory,
    args: {
        imageModeConfigOverride: { calibrationTopic: undefined },
    },
};
export const MessageConverterSupport = {
    render: function Story() {
        ...
        const customAnnotationsMessage = {
...
const AnnotationsUpdateStory = (imageModeConfigOverride = {}) => {
    ...
    const annotationShouldDisappear = {
...
function moveAnnotations(annotation, vector) {
...
export const AnnotationsUpdate = {
    parameters: {
        useReadySignal: true,
    },
...
function UpdateLineStory({ messages }) {
    const readySignal = useReadySignal();
    const width = 60;
    const height = 45;
    const { calibrationMessage, cameraMessage } = makeRawImageAndCalibration({
...
export const UpdateLineChangeVertexColors = {
    parameters: {
        useReadySignal: true,
    },
...
export const UpdateLineEnableVertexColors = {
    parameters: {
        useReadySignal: true,
    },
    render: UpdateLineStory,
...
export const OddLengthLineList = {
    render: function Story() {
        const width = 60;
        const height = 45;
        const { calibrationMessage, cameraMessage } = makeRawImageAndCalibration({
        ...
        return (_jsx("div", { style: { width: 1200, height: 900, flexShrink: 0 }, children: _jsx(PanelSetup, { fixture: fixture, includeSettings: true, children: _jsx(ImagePanel, { overrideConfig: {
                        ...ImagePanel.defaultConfig,
                        imageMode: {
                            calibrationTopic: "calibration",
                            imageTopic: "camera",
...
export const LinesWithAndWithoutVertexColors = {
    render: function Story() {
        const width = 60;
        const height = 45;
        const { calibrationMessage, cameraMessage } = makeRawImageAndCalibration({
...
const SyncAnnotationsStory = (args) => {
    ...
    const annotationTimestamp = status === "ready" ? cameraMessage.message.timestamp : { sec: 5, nsec: 0 };
    const annotationsMessage = {
        topic: "annotations",
        receiveTime: { sec: 10, nsec: 0 },
        message: {
    ...
    return (_jsx("div", { style: { width: 1200, height: 900, flexShrink: 0 }, children: _jsx(PanelSetup, { fixture: fixture, children: _jsx(ImagePanel, { overrideConfig: {
                    ...ImagePanel.defaultConfig,
                    imageMode: {
...
export const SyncAnnotationsWaitingWithCalibration = {
...
export const SyncAnnotationsWaitingWithoutCalibration = {
    render: SyncAnnotationsStory,
    args: {
...
export const SyncAnnotationsReadyWithCalibration = {
    render: SyncAnnotationsStory,
    args: {
        hasCalibrationTopic: true,
        status: "ready",
...
export const SyncAnnotationsReadyWithoutCalibration = {
    render: SyncAnnotationsStory,
    args: {
        hasCalibrationTopic: false,
        status: "ready",
