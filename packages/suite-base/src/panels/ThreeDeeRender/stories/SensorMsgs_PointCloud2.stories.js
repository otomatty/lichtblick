...
export const SensorMsgs_PointCloud2_RGBA = {
    render: () => _jsx(SensorMsgs_PointCloud2, { rgbaFieldName: "rgba" }),
    parameters: { colorScheme: "dark" },
};
export const SensorMsgs_PointCloud2_RGB = {
    render: () => _jsx(SensorMsgs_PointCloud2, { rgbaFieldName: "rgb" }),
    parameters: { colorScheme: "dark" },
};
function SensorMsgs_PointCloud2({ rgbaFieldName }) {
    const topics = [
...
export const SensorMsgs_PointCloud2_Intensity = {
    parameters: { colorScheme: "dark" },
...
export const SensorMsgs_PointCloud2_TwoDimensions = {
    render: function Story() {
        const topics = [{ name: "/pointcloud", schemaName: "sensor_msgs/PointCloud2" }];
        const SCALE = 10 / 128;
        function f(x, y) {
            return (x / 128 - 0.5) ** 2 + (y / 128 - 0.5) ** 2;
        }
