...
export const Foxglove_PointCloud_RGBA_Settings = {
    render: () => _jsx(Foxglove_PointCloud, { includeSettings: true }),
    play: async () => {
        await userEvent.click(await screen.findByTestId("settings__nodeHeaderToggle__general"));
        await userEvent.click(await screen.findByTestId("settings__nodeHeaderToggle__topics-/pointcloud"));
    },
};
export const Foxglove_PointCloud_RGBA_SettingsChinese = {
    ...Foxglove_PointCloud_RGBA_Settings,
    parameters: { forceLanguage: "zh" },
};
export const Foxglove_PointCloud_RGBA_SettingsJapanese = {
    ...Foxglove_PointCloud_RGBA_Settings,
    parameters: { forceLanguage: "ja" },
};
export const Foxglove_PointCloud_Gradient_Settings = {
    render: () => _jsx(Foxglove_PointCloud, { colorMode: "gradient", includeSettings: true }),
    play: async () => {
        await userEvent.click(await screen.findByTestId("settings__nodeHeaderToggle__general"));
        await userEvent.click(await screen.findByTestId("settings__nodeHeaderToggle__topics-/pointcloud"));
    },
};
export const Foxglove_PointCloud_Gradient_SettingsChinese = {
    ...Foxglove_PointCloud_Gradient_Settings,
    parameters: { forceLanguage: "zh" },
};
export const Foxglove_PointCloud_Gradient_SettingsJapanese = {
    ...Foxglove_PointCloud_Gradient_Settings,
    parameters: { forceLanguage: "ja" },
};
export const Foxglove_PointCloud_RGBA = {
    render: () => _jsx(Foxglove_PointCloud, {}),
};
export const Foxglove_PointCloud_RGBA_Square = {
    render: () => _jsx(Foxglove_PointCloud, { pointShape: "square" }),
};
export const Foxglove_PointCloud_Gradient = {
    render: () => _jsx(Foxglove_PointCloud, { colorMode: "gradient" }),
};
export const Foxglove_PointCloud_Gradient_Clamped = {
    render: () => _jsx(Foxglove_PointCloud, { colorMode: "gradient", minValue: -2, maxValue: 2 }),
};
export const Foxglove_PointCloud_Stixels = {
    render: () => _jsx(Foxglove_PointCloud, { colorMode: "gradient", stixelsEnabled: true }),
};
function Foxglove_PointCloud({ pointShape = "circle", colorMode = "rgba-fields", minValue, maxValue, stixelsEnabled = false, debugPicking = false, includeSettings = false, }) {
    const topics = [
    ...
    return (_jsx(PanelSetup, { fixture: fixture, includeSettings: includeSettings, children: _jsx(ThreeDeePanel, { debugPicking: debugPicking, overrideConfig: {
                followTf: "base_link",
                topics: {
                    "/pointcloud": {
                        visible: true,
...
function Foxglove_PointCloud_Intensity_Base({ minValue, maxValue, }) {
    const topics = [
        { name: "/pointcloud", schemaName: "foxglove.PointCloud" },
        { name: "/tf", schemaName: "geometry_msgs/TransformStamped" },
    ];
    ...
    function countInside(xi, yi, zi) {
        const p0 = [xi * SCALE - HW - SCALE_2, yi * SCALE - HW - SCALE_2, zi * SCALE - SCALE_2];
        const p1 = [xi * SCALE - HW + SCALE_2, yi * SCALE - HW - SCALE_2, zi * SCALE - SCALE_2];
        const p2 = [xi * SCALE - HW - SCALE_2, yi * SCALE - HW + SCALE_2, zi * SCALE - SCALE_2];
        const p3 = [xi * SCALE - HW + SCALE_2, yi * SCALE - HW + SCALE_2, zi * SCALE - SCALE_2];
        const p4 = [xi * SCALE - HW - SCALE_2, yi * SCALE - HW - SCALE_2, zi * SCALE + SCALE_2];
        const p5 = [xi * SCALE - HW + SCALE_2, yi * SCALE - HW - SCALE_2, zi * SCALE + SCALE_2];
        const p6 = [xi * SCALE - HW - SCALE_2, yi * SCALE - HW + SCALE_2, zi * SCALE + SCALE_2];
        const p7 = [xi * SCALE - HW + SCALE_2, yi * SCALE - HW + SCALE_2, zi * SCALE + SCALE_2];
        return (inside(p0) +
            inside(p1) +
            inside(p2) +
            inside(p3) +
...
export const Foxglove_PointCloud_Intensity = {
    render: () => Foxglove_PointCloud_Intensity_Base({}),
};
export const Foxglove_PointCloud_Intensity_Clamped = {
    render: () => Foxglove_PointCloud_Intensity_Base({
        minValue: 80,
        maxValue: 130,
    }),
};
export const Foxglove_PointCloud_TwoDimensions = {
    render: function Story() {
        const topics = [{ name: "/pointcloud", schemaName: "foxglove.PointCloud" }];
        const SCALE = 10 / 128;
        function f(x, y) {
            return (x / 128 - 0.5) ** 2 + (y / 128 - 0.5) ** 2;
        }
...
export const Foxglove_PointCloud_HistoryPicking = {
...
/** Click first cloud */
export const Foxglove_PointCloud_HistoryPickingInstances1 = {
    render: HistoryPickingStory,
    async play() {
        await userEvent.click(await screen.findByTestId("ExpandingToolbar-Inspect objects"));
        await userEvent.pointer({
...
/** Click second cloud */
export const Foxglove_PointCloud_HistoryPickingInstances2 = {
    render: HistoryPickingStory,
    async play() {
        await userEvent.click(await screen.findByTestId("ExpandingToolbar-Inspect objects"));
        await userEvent.pointer({
...
export const Foxglove_PointCloud_Distance = {
    render: () => _jsx(Foxglove_PointCloud_Distance_Base, {}),
};
