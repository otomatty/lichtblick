...
export const FoxgloveFrameTransforms = {
    ...
    play: async () => {
        ...
        await userEvent.click(await screen.findByTestId("settings__nodeHeaderToggle__transforms-settings"));
        await userEvent.click(await screen.findByTestId("settings__nodeHeaderToggle__transforms-frame:base_link"));
        await userEvent.click(await screen.findByTestId("settings__nodeHeaderToggle__transforms-frame:sensor_1"));
    },
};
export const FoxgloveFrameTransformsChinese = {
    ...FoxgloveFrameTransforms,
    parameters: { forceLanguage: "zh" },
};
export const FoxgloveFrameTransformsJapanese = {
    ...FoxgloveFrameTransforms,
