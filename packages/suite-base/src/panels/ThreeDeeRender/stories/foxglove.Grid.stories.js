...
function makeGridData({ rows, cols, pattern }) {
...
function copyGridAtPosition(grid, position, topicName) {
    return {
        ...grid,
        topic: topicName,
        message: {
...
function Foxglove_Grid_Uint8({ minValue, maxValue, }) {
    const topics = [
    ...
    const grid2 = copyGridAtPosition(grid, {
        x: -0.5 * cell_size.x * rowCount + 2,
        y: -0.5 * cell_size.y * column_count - 2,
        z: 0,
    }, "/grid2");
    topics.push({ name: "/grid2", schemaName: "foxglove.Grid" });
    const grid3 = copyGridAtPosition(grid, {
        x: -0.5 * cell_size.x * rowCount - 2,
        y: -0.5 * cell_size.y * column_count + 2,
        z: 0,
    }, "/grid3");
    topics.push({ name: "/grid3", schemaName: "foxglove.Grid" });
    const grid4 = copyGridAtPosition(grid, {
        x: -0.5 * cell_size.x * rowCount - 2,
        y: -0.5 * cell_size.y * column_count - 2,
        z: 0,
    }, "/grid4");
...
function Foxglove_Grid_Float({ minValue, maxValue, }) {
    const topics = [
        { name: "/grid", schemaName: "foxglove.Grid" },
        { name: "/tf", schemaName: "geometry_msgs/TransformStamped" },
    ];
...
export const Foxglove_Grid_Uint8_Values = {
    render: () => _jsx(Foxglove_Grid_Uint8, {}),
};
export const Foxglove_Grid_Uint8_Values_Clamped = {
    render: () => _jsx(Foxglove_Grid_Uint8, { minValue: 30, maxValue: 80 }),
};
export const Foxglove_Grid_RGBA_Values = {
    render: () => _jsx(Foxglove_Grid_RGBA, {}),
};
export const Foxglove_Grid_Float_Values = {
    render: () => _jsx(Foxglove_Grid_Float, {}),
};
export const Foxglove_Grid_Float_Values_Clamped = {
    render: () => _jsx(Foxglove_Grid_Float, { minValue: 0.05, maxValue: 0.1 }),
};
export const Foxglove_Grid_Padded_Row = {
    render: () => _jsx(Row_Stride_Grid, {}),
};
