...
export const PoseEstimatePosition = {
    render: PublishClickToolTemplate,
...
export const PoseEstimateComplete = {
    render: PublishClickToolTemplate,
    args: { type: "pose_estimate" },
    play: async () => {
        (await screen.findByTestId("publish-button")).click();
...
export const SettingsChinese = {
    ...Settings,
    parameters: { forceLanguage: "zh" },
};
export const SettingsJapanese = {
    ...Settings,
    parameters: { forceLanguage: "ja" },
};
function PublishClickToolTemplate({ type, includeSettings, }) {
