...
export const ImageRender = {
    render: function Story({ includeSettings }) {
        const topics = [
        ...
        return (_jsx(PanelSetup, { fixture: fixture, includeSettings: includeSettings, children: _jsx(ThreeDeePanel, { overrideConfig: {
...
export const ImageRenderSettings = {
    ...ImageRender,
    args: { includeSettings: true },
    play: async () => {
        await userEvent.click(await screen.findByTestId("settings__nodeHeaderToggle__topics-/cam1/info"));
    },
};
export const ImageRenderSettingsChinese = {
    ...ImageRenderSettings,
    args: { includeSettings: true },
    parameters: { forceLanguage: "zh" },
};
export const ImageRenderSettingsJapanese = {
    ...ImageRenderSettings,
    args: { includeSettings: true },
    parameters: { forceLanguage: "ja" },
};
export const FoxgloveImage = {
...
export const UpdateImageToGreen = {
    parameters: {
        useReadySignal: true,
    },
    render: function Story() {
