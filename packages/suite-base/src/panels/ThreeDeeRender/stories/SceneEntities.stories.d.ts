...
export declare const BasicEntities: StoryObj;
export declare const UpdatedLineLoopsDontHaveExtraLines: StoryObj;
export declare const ProcessesSameSceneTwice: StoryObj;
