...
export class RenderableSpheres extends RenderablePrimitive {
    ...
    #updateMesh(spheres) {
        ...
        for (const sphere of spheres) {
            ...
            this.#mesh.setMatrixAt(i, tempMat4.compose(tempVec3.set(sphere.pose.position.x, sphere.pose.position.y, sphere.pose.position.z), tempQuat.set(sphere.pose.orientation.x, sphere.pose.orientation.y, sphere.pose.orientation.z, sphere.pose.orientation.w), tempVec3_2.set(sphere.size.x, sphere.size.y, sphere.size.z)));
            i++;
        }
