...
export class RenderableCubes extends RenderablePrimitive {
    ...
    #updateMesh(cubes) {
        ...
        for (const cube of cubes) {
            ...
            this.#mesh.setMatrixAt(i, tempMat4.compose(tempVec3.set(cube.pose.position.x, cube.pose.position.y, cube.pose.position.z), tempQuat.set(cube.pose.orientation.x, cube.pose.orientation.y, cube.pose.orientation.z, cube.pose.orientation.w), tempVec3_2.set(cube.size.x, cube.size.y, cube.size.z)));
            i++;
        }
...
function createEdgesGeometry(cubeGeometry) {
