...
export class ImageModeCamera extends THREE.PerspectiveCamera {
    ...
    updateZoomFromWheel(ratio, cursorCoords) {
        ...
        this.#panOffset.set((halfWidth + this.#panOffset.x - cursorCoords.x) * finalRatio - halfWidth + cursorCoords.x, (halfHeight + this.#panOffset.y - cursorCoords.y) * finalRatio - halfHeight + cursorCoords.y);
    ...
    getEffectiveScale() {
        ...
        return Math.min((canvasWidth / this.#model.width) * this.#aspectZoom.x, (canvasHeight / this.#model.height) * this.#aspectZoom.y);
    }
    /**
