...
import { normalizeCompressedImage, normalizeCompressedVideo, normalizeRawImage, normalizeRosCompressedImage, normalizeRosImage, } from "./imageNormalizers";
describe("imageNormalizers", () => {
    ...
    describe("normalizeRosImage", () => {
        ...
        it("should handle partial header", () => {
            const input = { header: { frame_id: "partial_frame" } };
            const expected = {
