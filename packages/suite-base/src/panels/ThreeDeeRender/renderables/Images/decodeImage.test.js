...
import { decodeCompressedImageToBitmap, isVideoKeyframe, getVideoDecoderConfig, decodeCompressedVideoToBitmap, decodeRawImage, emptyVideoFrame, } from "./decodeImage";
function createMockVideoFrame(override) {
    return {
        data: new Uint8Array([]),
        format: "h264",
...
describe("decodeRawImage", () => {
    function createMockROSImage(override) {
        return {
            encoding: "rgb8",
            width: 2,
            height: 2,
