...
export function markerHasTransparency(marker) {
    switch (marker.type) {
...
export function makeStandardMaterial(color) {
...
export function makeStandardVertexColorMaterial(marker) {
...
export function makeStandardInstancedMaterial(marker) {
    const transparent = markerHasTransparency(marker);
    return new THREE.MeshStandardMaterial({
        metalness: 0,
        roughness: 1,
...
export function makeLinePrepassMaterial(marker, options) {
...
export function makeLineMaterial(marker, options) {
    const lineWidth = marker.scale.x;
    const transparent = markerHasTransparency(marker);
    const material = new LineMaterialWithAlphaVertex({
        worldUnits: options.worldUnits ?? true,
...
export function makeLinePickingMaterial(lineWidth, options) {
...
export function makePointsMaterial(marker) {
    const transparent = markerHasTransparency(marker);
