...
export class RenderableCube extends RenderableMarker {
    ...
    constructor(topic, marker, receiveTime, renderer) {
        ...
        // Cube mesh
        const cubeGeometry = this.renderer.sharedGeometry.getGeometry(`${this.constructor.name}-cube`, createGeometry);
        const cubeEdgesGeometry = this.renderer.sharedGeometry.getGeometry(`${this.constructor.name}-cube-edges`, () => createEdgesGeometry(cubeGeometry));
