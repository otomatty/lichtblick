...
import { sphereSubdivisions } from "../../lod";
export class RenderableSphere extends RenderableMarker {
    mesh;
    constructor(topic, marker, receiveTime, renderer) {
        super(topic, marker, receiveTime, renderer);
        // Sphere mesh
        const geometry = renderer.sharedGeometry.getGeometry(`${this.constructor.name}-${renderer.maxLod}`, () => createGeometry(renderer.maxLod));
...
export function createGeometry(lod) {
