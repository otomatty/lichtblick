...
export class MeasurementTool extends SceneExtension {
    static extensionId = "foxglove.MeasurementTool";
     ...
     * it's occluded
     */
    #lineOccluded = new THREE.Line(new THREE.BufferGeometry(), new THREE.LineDashedMaterial({
        color: 0xff0000,
        dashSize: 1,
        gapSize: 1,
        depthWrite: false,
    ...
    #point2;
    state = "idle";
    constructor(renderer, name = MeasurementTool.extensionId) {
        super(name, renderer);
