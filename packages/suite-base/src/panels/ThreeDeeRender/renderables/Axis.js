...
export class Axis extends THREE.Object3D {
    ...
    constructor(name, renderer) {
        ...
        const shaftGeometry = this.#renderer.sharedGeometry.getGeometry(`${this.constructor.name}-shaft-${this.#renderer.maxLod}`, () => createShaftGeometry(this.#renderer.maxLod));
        ...
        const headGeometry = this.#renderer.sharedGeometry.getGeometry(`${this.constructor.name}-head-${this.#renderer.maxLod}`, () => createHeadGeometry(this.#renderer.maxLod));
    ...
    static #UpdateInstances(shaft, head, axisIndex) {
