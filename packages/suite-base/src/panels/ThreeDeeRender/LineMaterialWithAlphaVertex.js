...
export class LineMaterialWithAlphaVertex extends ShaderMaterial {
    ...
    constructor(parameters) {
        ...
        super({
            type: "LineMaterial",
            uniforms: UniformsUtils.clone(ShaderLib["foxglove.line"].uniforms),
            vertexShader: ShaderLib["foxglove.line"].vertexShader,
            fragmentShader: ShaderLib["foxglove.line"].fragmentShader,
