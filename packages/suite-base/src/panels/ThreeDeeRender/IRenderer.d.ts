...
import { Immutable, MessageEvent, ParameterValue, SettingsIcon, Topic, VariableValue } from "@lichtblick/suite";
import { PanelContextMenuItem } from "@lichtblick/suite-base/components/PanelContextMenu";
import { BuiltinPanelExtensionContext, DraggedMessagePath, MessagePathDropStatus } from "@lichtblick/suite-base/components/PanelExtensionAdapter";
...
export type RendererEvents = {
    ...
    renderablesClicked: (selections: PickedRenderable[], cursorCoords: {
        x: number;
        y: number;
    }, renderer: IRenderer) => void;
    selectedRenderable: (selection: PickedRenderable | undefined, renderer: IRenderer) => void;
    parametersChange: (parameters: ReadonlyMap<string, ParameterValue> | undefined, renderer: IRenderer) => void;
...
export declare class InstancedLineMaterial extends THREE.LineBasicMaterial {
