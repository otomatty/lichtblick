...
export const FRAME_TRANSFORM_DATATYPES = new Set();
addFoxgloveSchema(FRAME_TRANSFORM_DATATYPES, "foxglove.FrameTransform");
export const FRAME_TRANSFORMS_DATATYPES = new Set();
...
export const RAW_IMAGE_DATATYPES = new Set();
...
export function addFoxgloveSchema(output, dataType) {
