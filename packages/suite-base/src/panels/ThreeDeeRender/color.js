...
export function stringToRgba(output, colorStr) {
...
export function stringToRgb(output, colorStr) {
    const color = tinycolor(colorStr);
    if (!color.isValid()) {
 ...
 */
export function rgbaGradient(output, a, b, t) {
    const aR = a.r * a.a;
    const aG = a.g * a.a;
    const aB = a.b * a.a;
    const bR = b.r * b.a;
