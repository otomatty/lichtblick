...
export function initPanel(crash, context) {
    return createSyncRoot(_jsx(CaptureErrorBoundary, { onError: crash, children: _jsx(MapPanel, { context: context }) }), context.panelElement);
}
