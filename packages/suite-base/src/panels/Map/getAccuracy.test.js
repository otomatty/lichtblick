...
import { NavSatFixPositionCovarianceType, } from "@lichtblick/suite-base/panels/Map/types";
describe("getAccuracy", () => {
    ...
    describe("'diagaonal' covariance type", () => {
        it("returns an ellipsoid", () => {
            ...
            const { radii: [r1, r2], tilt, } = getAccuracy(msg);
    ...
    describe("'known' covariance type", () => {
        it("may return circular variance", () => {
            ...
            const { radii: [r1, r2], } = getAccuracy(msg);
            expect(r1).toBe(5);
            expect(r2).toBe(5);
        });
