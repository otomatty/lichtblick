...
import { extractQueriedData, isValidValue, getColor, createLabel, baseColors, messagesToDataset, } from "./messagesToDataset";
...
function MessageAndDataBuilder(messageEventInput, value, pathInput, constantName) {
    return {
...
describe("messagesToDataset helper functions", () => {
    ...
    it("should return undefined when queriedData's argument has an empty array", () => {
        const messageAndDataWithEmptyQueriedData = {
            messageEvent,
            queriedData: [],
        };
    ...
    it("should return undefined when queriedData's argument has more than one item", () => {
        ...
        const messageAndDataWithMultipleItemsOnQueriedData = {
            messageEvent,
            queriedData: [
...
describe("messagesToDataset", () => {
    ...
    it("should return undefined because getTimestampForMessageEvent will return undefined", () => {
        ...
        const blocks = [
            [
                MessageAndDataBuilder({ ...messageEvent, message: { header: undefined } }, queriedDataValue, queriedDataPath, queriedDataName),
            ],
        ];
        const argsDataset = {
            ...args,
    ...
    it("should return dataset with 1 item on data[] because getTimestampForMessageEvent is called with headerStamp with header", () => {
        ...
        const blocks = [
            [
                MessageAndDataBuilder({ ...messageEvent, message: { header: { stamp: RosTimeBuilder.time() } } }, queriedDataValue, queriedDataPath, queriedDataName),
            ],
        ];
        const argsDataset = {
            ...args,
    ...
    it("should not assign a label to repeated consecutive data points", () => {
        ...
        const blocks = [[messageAndData, messageAndData]];
