...
import { nestedTabLayoutFixture, nestedTabLayoutFixture2, } from "@lichtblick/suite-base/panels/Tab/nestedTabLayoutFixture";
import PanelSetup from "@lichtblick/suite-base/stories/PanelSetup";
import { ExpectedResult } from "@lichtblick/suite-base/stories/storyHelpers";
import Tab from "./index";
const SamplePanel1 = () => (_jsxs("div", { children: [_jsx(PanelToolbar, {}), _jsx("div", { children: "Sample Panel 1" })] }));
SamplePanel1.panelType = "Sample1";
SamplePanel1.defaultConfig = {};
const SamplePanel2 = () => (_jsxs("div", { children: [_jsx(PanelToolbar, {}), _jsx("div", { children: "Sample Panel 2" })] }));
...
export default {
    ...
    decorators: [
        (Wrapped, ctx) => {
            const { args: { disableMockCatalog = false, showPanelList = false, fixture: fixtureArg, ...storyArgs }, } = ctx;
            const panelCatalog = !disableMockCatalog ? new MockPanelCatalog() : undefined;
            const theme = useTheme();
            return (_jsxs(PanelSetup, { panelCatalog: panelCatalog, fixture: fixtureArg, children: [_jsx(Wrapped, { ...storyArgs }), showPanelList && (_jsx("div", { style: {
                            backgroundColor: theme.palette.background.paper,
                            borderInlineStart: `1px solid ${theme.palette.divider}`,
                        }, children: _jsx(PanelCatalogComponent, { onPanelSelect: () => { } }) }))] }));
        },
    ],
};
...
export const ShowingPanelList = {
    render: () => _jsx(Tab, {}),
    args: { fixture },
    name: "showing panel list",
};
export const ShowingPanelListLight = {
    ...ShowingPanelList,
    name: "showing panel list light",
    parameters: { colorScheme: "light" },
};
export const PickingAPanelFromThePanelListCreatesANewTabIfThereAreNone = {
    render: () => _jsx(PanelLayout, {}),
    args: {
        fixture: {
            ...fixture,
...
export const PickingAPanelFromThePanelListUpdatesTheTabsLayout = {
    render: () => _jsx(PanelLayout, {}),
    args: {
        fixture: {
            ...fixture,
...
export const DraggingAPanelFromThePanelListUpdatesTheTabsLayout = {
    render: () => _jsx(PanelLayout, {}),
    args: {
        showPanelList: true,
        fixture: {
...
export const DraggingAPanelFromThePanelListCreatesANewTabIfThereAreNone = {
    render: () => _jsx(PanelLayout, {}),
    args: {
        showPanelList: true,
        fixture: {
...
export const WithChosenActiveTab = {
    render: (args) => _jsx(Tab, { ...args }),
    args: {
        overrideConfig: {
            activeTabIdx: 1,
            tabs: [
...
export const ReorderTabsWithinTabPanelByDroppingOnTab = {
    render: () => (_jsxs(_Fragment, { children: [_jsx(PanelLayout, {}), _jsx(ExpectedResult, { children: "Expected result: #2, #3, #1, #4, #5" })] })),
    args: {
        fixture: {
            ...fixture,
            savedProps: { "Tab!a": { activeTabIdx: 0, tabs: manyTabs.slice(0, 5) } },
...
export const MoveTabToDifferentTabPanel = {
    render: () => (_jsxs(_Fragment, { children: [_jsx(PanelLayout, {}), _jsx(ExpectedResult, { left: 0, children: "Should have only #2" }), _jsx(ExpectedResult, { left: "50%", children: "Should have #1 and #3" })] })),
...
export const PreventDraggingSelectedParentTabIntoChildTabPanel = {
    render: () => (_jsxs(_Fragment, { children: [_jsx(PanelLayout, {}), _jsx(ExpectedResult, { children: "the first tab should be hidden (we never dropped it)" }), _jsx(ExpectedResult, { top: 50, children: "tab content should be hidden" })] })),
    args: {
        fixture: {
            ...fixture,
            savedProps: {
...
export const DraggingAndDroppingANestedTabPanelDoesNotRemoveAnyTabs = {
    render: () => _jsx(PanelLayout, {}),
...
export const SupportsDraggingBetweenTabsAnywhereInTheLayout = {
    render: () => _jsx(PanelLayout, {}),
...
export const DraggingOntoTabRootDoesNotReplaceTabContents = {
    render: () => _jsx(PanelLayout, {}),
    args: {
        fixture: {
            topics: [],
    ...
    play: async ({ canvasElement }) => {
        ...
        await expect(await canvas.findByTestId("panel-mouseenter-container unknown!inner1")).toBeInTheDocument();
        await expect(await canvas.findByTestId("panel-mouseenter-container unknown!inner2")).toBeInTheDocument();
    },
};
