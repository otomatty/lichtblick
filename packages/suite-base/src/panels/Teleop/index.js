...
function initPanel(crash, context) {
    return createSyncRoot(_jsx(CaptureErrorBoundary, { onError: crash, children: _jsx(TeleopPanel, { context: context }) }), context.panelElement);
}
function TeleopPanelAdapter(props) {
