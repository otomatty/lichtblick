...
describe("getDiagnosticsWithStales", () => {
    ...
    const createDiagnosticInfo = (stamp, level = 1) => {
    ...
    it("should mark diagnostics as STALE when stamp is older than staleTime", () => {
        ...
        const diagnosticsByName = new Map([[id, diagnostic]]);
    ...
    it("should preserve all hardwareId and diagnostic names", () => {
        ...
        const diagnosticById1 = new Map([[id1, diagnosticInfo1]]);
        const diagnosticById2 = new Map([[id2, diagnosticInfo2]]);
