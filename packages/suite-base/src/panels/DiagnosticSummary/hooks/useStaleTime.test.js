...
import { useMessagePipelineGetter, useMessagePipeline, } from "@lichtblick/suite-base/components/MessagePipeline";
...
describe("useStaleTime", () => {
    ...
    const mockUseMessagePipeline = useMessagePipeline;
    beforeEach(() => {
        jest.clearAllMocks();
    });
