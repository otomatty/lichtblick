...
import useDiagnostics, { addMessages } from "./useDiagnostics";
...
describe("addMessages", () => {
    const computeDiagnosticInfoMock = computeDiagnosticInfo;
    beforeEach(() => {
    ...
    it("should move a message from one level to another", () => {
        ...
        const messageEvent1 = MessageEventBuilder.messageEvent({
            message: DiagnosticsBuilder.statusArrayMsg({
        ...
        const messageEvent2 = MessageEventBuilder.messageEvent({
            message: DiagnosticsBuilder.statusArrayMsg({
    ...
    it("should return the same map reference if nothing was modified", () => {
        ...
        const diagnosticsResult = new Map([
...
describe("useDiagnostics", () => {
    const useMessageReducerMock = PanelAPI.useMessageReducer;
    beforeEach(() => {
