...
export default function MaybeCollapsedValue({ itemLabel }) {
    ...
    if (!lengthOverLimit) {
        return _jsx("span", { children: itemLabel });
    }
    return (_jsx(Tooltip, { title: !showingEntireLabel ? "Text was truncated, click to see all" : "", placement: "top", children: _jsx("span", { onClick: expandText, style: { cursor: !showingEntireLabel ? "pointer" : "inherit" }, children: `${truncatedItemText}${!showingEntireLabel ? "…" : ""}` }) }));
}
