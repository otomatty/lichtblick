...
export default function HighlightedValue({ itemLabel }) {
    ...
    if (itemLabelContainsChange) {
        ...
        return (_jsxs(DiffSpan, { style: { color: diffLabels.CHANGED.color }, children: [_jsx(MaybeCollapsedValue, { itemLabel: beforeText }), diffArrowStr, _jsx(MaybeCollapsedValue, { itemLabel: afterText })] }));
    }
    return (_jsx(DiffSpan, { children: _jsx(MaybeCollapsedValue, { itemLabel: itemLabel }) }));
}
