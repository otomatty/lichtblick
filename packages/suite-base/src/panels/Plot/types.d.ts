...
export type WheelInteractionEvent = {
    type: "wheel";
} & BaseInteractionEvent & MouseBase;
...
export type PanEndInteractionEvent = {
    type: "panend";
} & BaseInteractionEvent;
export type InteractionEvent = WheelInteractionEvent | PanStartInteractionEvent | PanMoveInteractionEvent | PanEndInteractionEvent;
...
export type MutableContext<T> = Omit<Chart, "ctx"> & {
    ctx: T;
};
...
export type UsePlotDataHandling = {
    ...
    datasetsBuilder: TimestampDatasetsBuilder | IndexDatasetsBuilder | CustomDatasetsBuilder | CurrentCustomDatasetsBuilder;
};
