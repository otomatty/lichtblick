...
const TestWrapper = ({ children }) => {
    ...
    return (_jsx(PanelContext.Provider, { value: contextValue, children: _jsx("div", { children: children }) }));
};
const setup = (overrides = {}) => {
    const props = { ...defaultProps, ...overrides };
    return render(_jsx(PanelContext.Provider, { value: getContextValue(), children: _jsx(TestWrapper, { children: _jsx(PlotLegend, { coordinator: undefined, legendDisplay: "floating", onClickPath: jest.fn(), showValues: false, ...props }) }) }));
};
...
describe("PlotLegend", () => {
    ...
    beforeEach(() => {
        useSelectedPanels.mockReturnValue({
