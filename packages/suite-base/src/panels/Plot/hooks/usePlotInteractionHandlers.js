...
const usePlotInteractionHandlers = ({ config, coordinator, draggingRef, renderer, setActiveTooltip, shouldSync, subscriberId, }) => {
    ...
    const buildTooltip = useMemo(() => {
        return debouncePromise(async (args) => {
    ...
    const onClick = useCallback((event) => {
        ...
        const { seekPlayback, playerState: { activeData: { startTime: start } = {} }, } = getMessagePipelineState();
    ...
    const onClickPath = useCallback((index) => {
