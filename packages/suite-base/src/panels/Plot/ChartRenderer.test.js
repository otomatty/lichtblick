...
describe("ChartRenderer", () => {
    ...
    function setup({ actionOverride } = {}) {
        ...
        getChartOptions.mockReturnValue(chartOptions);
    ...
    describe("update", () => {
        ...
        it("should update when wheel event type", () => {
            ...
            const fakeNodeEventsEmitSpy = jest.spyOn(chartRenderer.getFakeNodeEvents(), "emit");
            chartRenderer.update(action);
    ...
    describe("getElementsAtPixel", () => {
        it("should return elements sorted by proximity to a pixel", () => {
            ...
            const chartInstance = chartRenderer.getChartInstance();
            const elementsAtEventMock = [
                { element: { x: 10, y: 10 }, datasetIndex: 0, index: 0 },
                { element: { x: 30, y: 30 }, datasetIndex: 1, index: 1 },
                { element: { x: 20, y: 20 }, datasetIndex: 2, index: 2 },
            ];
            chartInstance.getElementsAtEventForMode.mockReturnValue(elementsAtEventMock);
        ...
        it("should return elements sorted by proximity to a pixel dinamically", () => {
            ...
            chartInstance.getElementsAtEventForMode.mockReturnValue([
