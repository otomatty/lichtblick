...
function initPanel(crash, context) {
    return createSyncRoot(_jsx(CaptureErrorBoundary, { onError: crash, children: _jsx(ThemeProvider, { isDark: true, children: _jsx(Indicator, { context: context }) }) }), context.panelElement);
}
function IndicatorLightPanelAdapter({ config, saveConfig }) {
...
export default Panel(Object.assign(IndicatorLightPanelAdapter, {
    panelType: "Indicator",
    defaultConfig: {},
}));
