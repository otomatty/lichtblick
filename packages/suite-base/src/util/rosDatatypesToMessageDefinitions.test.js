...
describe("rosDatatypesToMessageDefinition", () => {
    it(`Includes all of the definitions for "visualization_msgs/StudioMarkerArray"`, () => {
        expect(rosDatatypesToMessageDefinition(basicDatatypes, "visualization_msgs/MarkerArray")).toMatchSnapshot();
    });
    it("produces a correct message definition", () => {
        const definitions = rosDatatypesToMessageDefinition(basicDatatypes, "visualization_msgs/MarkerArray");
    ...
    it("Errors if it can't find the definition", () => {
        ...
        expect(() => rosDatatypesToMessageDefinition(datatypes, "visualization_msgs/MarkerArray")).toThrow('While searching datatypes for "visualization_msgs/MarkerArray", could not find datatype "std_msgs/CustomHeader"');
    });
});
