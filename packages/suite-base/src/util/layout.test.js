...
import { getPanelTypeFromId, getSaveConfigsPayloadForAddedPanel, removePanelFromTabPanel, getPanelIdsInsideTabPanels, createAddUpdates, addPanelToTab, replaceAndRemovePanels, updateTabPanelLayout, validateTabPanelConfig, moveTabBetweenTabPanels, reorderTabWithinTabPanel, getPathFromNode, getParentTabPanelByPanelId, } from "./layout";
const tabConfig = {
    title: "First tab",
...
describe("layout", () => {
    ...
    describe("removePanelFromTabPanel", () => {
        it("single panel layout", () => {
            expect(removePanelFromTabPanel([], {
                activeTabIdx: 0,
                tabs: [
        ...
        it("multiple panel layout", () => {
            expect(removePanelFromTabPanel(["second"], {
                activeTabIdx: 0,
                tabs: [
                    {
                        title: "1",
    ...
    describe("getPanelIdsInsideTabPanels", () => {
        it("gets nothing when no tab panels are specified", () => {
            expect(getPanelIdsInsideTabPanels([], {
                "Tab!a": {
        ...
        it("gets nested panels in specified tab panels' tabs", () => {
            expect(getPanelIdsInsideTabPanels(["Tab!a"], {
                "Tab!a": {
                    tabs: [
                        { layout: "Image!a" },
        ...
        it("gets nested panels in multiple specified tab panels' tabs", () => {
            expect(getPanelIdsInsideTabPanels(["Tab!a", "Tab!b"], {
                "Tab!a": {
                    tabs: [
                        { layout: "Image!a" },
                        { layout: { direction: "row", first: "Image!b", second: "RosOut!a" } },
    ...
    describe("addPanelToTab", () => {
        it("can add a new panel into a tab config", () => {
            expect(addPanelToTab("DiagnosticSummary!30vin8", [], "bottom", {
                activeTabIdx: 0,
                tabs: [
                    { title: "1", layout: "DiagnosticSummary!3v8mswd" },
                    { title: "2", layout: undefined },
        ...
        it("empty tab layout", () => {
            expect(addPanelToTab("DiagnosticSummary!4dpz3hc", undefined, undefined, { activeTabIdx: 0, tabs: [{ title: "1", layout: undefined }] }, "Tab!3u9ypnk")).toEqual({
                configs: [
                    {
                        id: "Tab!3u9ypnk",
                        config: {
        ...
        it("no tabs", () => {
            expect(addPanelToTab("DiagnosticSummary!48lhb5y", undefined, undefined, { activeTabIdx: -1, tabs: [] }, "Tab!1pyr7sm")).toEqual({
                configs: [
                    {
                        id: "Tab!1pyr7sm",
                        config: {
    ...
    describe("replaceAndRemovePanels", () => {
        it("will replace multiple panel ids with new panel id", () => {
            expect(replaceAndRemovePanels({ originalId: "OldId!y", newId: "NewId!z", idsToRemove: ["RemoveMe!a", "RemoveMe!b"] }, {
                direction: "row",
        ...
        it("will just remove specified panels if no panel is specified to be replaced", () => {
            expect(replaceAndRemovePanels({ originalId: "OldId!y", idsToRemove: ["RemoveMe!a", "RemoveMe!b"] }, {
                direction: "row",
                first: "RemoveMe!b",
                second: {
                    direction: "row",
        ...
        it("will just remove specified panels if no panel is specified as replacement", () => {
            expect(replaceAndRemovePanels({ newId: "NewId!z", idsToRemove: ["RemoveMe!a", "RemoveMe!b"] }, {
                direction: "row",
                first: "RemoveMe!b",
                second: {
                    direction: "row",
        ...
        it("will remove whole layout if all panels are removed (without any replacement)", () => {
            expect(replaceAndRemovePanels({ idsToRemove: ["OldId!y", "RemoveMe!a", "RemoveMe!b"] }, {
                direction: "row",
                first: "RemoveMe!b",
                second: {
                    direction: "row",
        ...
        it("will not modify layouts that don't contain panelIdsToRemove", () => {
            ...
            expect(replaceAndRemovePanels({ idsToRemove: ["Missing!a", "Missing!b"] }, originalLayout)).toEqual(originalLayout);
        });
        it("will return undefined if all panels are replaced", () => {
            expect(replaceAndRemovePanels({ originalId: "OldId!y", idsToRemove: ["Remove!a", "Remove!b"] }, {
                direction: "row",
                first: "Remove!a",
                second: "Remove!b",
            })).toEqual(undefined);
    ...
    describe("updateTabPanelLayout", () => {
        it("correctly updates active tab's layout with single panel", () => {
            expect(updateTabPanelLayout("RosOut!abc", {
        ...
        it("correctly updates active tab's layout with multiple panels", () => {
            ...
            expect(updateTabPanelLayout(newLayout, {
                tabs: [{ title: "A", layout: undefined }],
                activeTabIdx: 0,
            })).toEqual({
                activeTabIdx: 0,
