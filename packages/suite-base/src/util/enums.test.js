...
import { constantsByDatatype, enumValuesByDatatypeAndField, extractTypeFromStudioEnumAnnotation, } from "./enums";
describe("selectors", () => {
    describe("constantsByDatatype", () => {
        it("indexes constant names by value for each datatype", () => {
            expect(constantsByDatatype(new Map(Object.entries({
                "some/datatype": {
                    definitions: [
    ...
    describe("enumValuesByDatatypeAndField", () => {
        it("handles multiple blocks of constants", () => {
            expect(enumValuesByDatatypeAndField(new Map(Object.entries({
                "some/datatype": {
                    definitions: [
                        { type: "uint32", name: "OFF", isConstant: true, value: 0 },
                        { type: "uint32", name: "ON", isConstant: true, value: 1 },
