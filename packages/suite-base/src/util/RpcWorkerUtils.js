...
import { setNotificationHandler, } from "@lichtblick/suite-base/util/sendNotification";
import overwriteFetch from "./overwriteFetch";
export function setupSendReportNotificationHandler(rpc) {
...
export function setupWorker(rpc) {
