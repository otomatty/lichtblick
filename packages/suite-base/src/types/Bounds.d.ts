 ...
 * ```
 */
export declare function unionBounds1D(a: Immutable<Bounds1D>, b: Immutable<Bounds1D>): Bounds1D;
/**
 * 境界値を指定した値を含むように拡張
 *
 ...
 */
export declare function extendBounds1D(bounds: Bounds1D, value: number): void;
