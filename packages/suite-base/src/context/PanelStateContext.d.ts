 ...
 */
export declare const PanelStateContext: import("react").Context<StoreApi<PanelStateStore> | undefined>;
/**
 ...
 * ```
 */
export declare function usePanelStateStore<T>(selector: (store: PanelStateStore) => T): T;
