 ...
 */
declare const ExtensionMarketplaceContext: import("react").Context<ExtensionMarketplace | undefined>;
/**
 ...
 */
export declare function useExtensionMarketplace(): ExtensionMarketplace;
