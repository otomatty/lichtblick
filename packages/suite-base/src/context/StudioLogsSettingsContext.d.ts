 ...
 * @see StudioLogConfigChannel - チャンネル設定
 */
declare const StudioLogsSettingsContext: import("react").Context<StoreApi<IStudioLogsSettings> | undefined>;
/**
 ...
 */
declare function useStudioLogsSettings(): IStudioLogsSettings;
