 ...
 * @see User - ユーザー情報の型定義
 */
declare const CurrentUserContext: import("react").Context<CurrentUser>;
/**
 ...
 * ```
 */
export declare function useCurrentUser(): CurrentUser;
/**
 * ユーザー認証タイプ
 *
 * ユーザーの認証状態とプランレベルを表す型定義
 */
export type UserType = "unauthenticated" | "authenticated-free" | "authenticated-team" | "authenticated-enterprise";
/**
 ...
 * ```
 */
export declare function useCurrentUserType(): UserType;
