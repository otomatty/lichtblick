 ...
 * ```
 */
export type NativeAppMenuEvent = "open" | "open-file" | "open-connection" | "open-demo" | "open-help-about" | "open-help-docs" | "open-help-general";
type Handler = () => void;
 ...
 */
declare const NativeAppMenuContext: import("react").Context<INativeAppMenu | undefined>;
