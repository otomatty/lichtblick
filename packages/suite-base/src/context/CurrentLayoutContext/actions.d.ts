...
import { MosaicDropTargetPosition, PanelConfig, PlaybackConfig, SavedProps, UserScripts } from "@lichtblick/suite-base/types/panels";
/**
 * レイアウトデータの型定義
 *
 ...
 * カスタムノードの追加や更新に使用される。
 */
export type SET_STUDIO_NODES = {
    type: "SET_USER_NODES";
    payload: Partial<UserScripts>;
};
/**
 * 再生設定アクション
 *
 ...
 */
export type SET_PLAYBACK_CONFIG = {
    type: "SET_PLAYBACK_CONFIG";
    payload: Partial<PlaybackConfig>;
};
/**
 * パネル閉じるペイロードの型定義
 *
 ...
 * 指定されたパネルを閉じるアクション。
 */
export type CLOSE_PANEL = {
    type: "CLOSE_PANEL";
    payload: ClosePanelPayload;
};
/**
 * パネル分割ペイロードの型定義
 *
 ...
 */
export type SPLIT_PANEL = {
    type: "SPLIT_PANEL";
    payload: SplitPanelPayload;
};
/**
 * パネル交換ペイロードの型定義
 *
 ...
 */
export type SWAP_PANEL = {
    type: "SWAP_PANEL";
    payload: SwapPanelPayload;
};
/**
 * タブ移動ペイロードの型定義
 *
 ...
 * 新しいパネルを追加するアクション。
 */
export type ADD_PANEL = {
    type: "ADD_PANEL";
    payload: AddPanelPayload;
};
/**
 * パネルドロップペイロードの型定義
 *
 ...
 * - タブ操作系: MOVE_TAB
 */
export type PanelsActions = CHANGE_PANEL_LAYOUT | SAVE_PANEL_CONFIGS | SAVE_FULL_PANEL_CONFIG | CREATE_TAB_PANEL | OVERWRITE_GLOBAL_DATA | SET_GLOBAL_DATA | SET_STUDIO_NODES | SET_PLAYBACK_CONFIG | CLOSE_PANEL | SPLIT_PANEL | SWAP_PANEL | MOVE_TAB | ADD_PANEL | DROP_PANEL | START_DRAG | END_DRAG;
export {};
