 ...
 */
export declare const UserProfileStorageContext: import("react").Context<UserProfileStorage | undefined>;
/**
 ...
 * ```
 */
export declare function useUserProfileStorage(): UserProfileStorage;
