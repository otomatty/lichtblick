...
export function App(props) {
    const { appConfiguration, appParameters = {}, dataSources, extensionLoaders, layoutLoaders, nativeAppMenu, nativeWindow, deepLinks, enableLaunchPreferenceScreen, enableGlobalCss = false, extraProviders, } = props;
    const providers = [
    ...
    providers.unshift(_jsx(CurrentLayoutProvider, { loaders: layoutLoaders }));
    ...
    return (_jsx(AppConfigurationContext.Provider, { value: appConfiguration, children: _jsx(AppParametersProvider, { appParameters: appParameters, children: _jsxs(ColorSchemeThemeProvider, { children: [enableGlobalCss && _jsx(GlobalCss, {}), _jsx(CssBaseline, { children: _jsx(ErrorBoundary, { children: _jsx(MaybeLaunchPreference, { children: _jsxs(MultiProvider, { providers: providers, children: [_jsx(DocumentTitleAdapter, {}), _jsx(SendNotificationToastAdapter, {}), _jsx(DndProvider, { backend: HTML5Backend, children: _jsx(Suspense, { fallback: _jsx(_Fragment, {}), children: _jsx(PanelCatalogProvider, { children: _jsx(Workspace, { deepLinks: deepLinks, appBarLeftInset: props.appBarLeftInset, onAppBarDoubleClick: props.onAppBarDoubleClick, showCustomWindowControls: props.showCustomWindowControls, isMaximized: props.isMaximized, onMinimizeWindow: props.onMinimizeWindow, onMaximizeWindow: props.onMaximizeWindow, onUnmaximizeWindow: props.onUnmaximizeWindow, onCloseWindow: props.onCloseWindow }) }) }) })] }) }) }) })] }) }) }));
}
