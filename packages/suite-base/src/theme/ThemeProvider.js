...
const ThemeContainer = React.forwardRef((props, _ref) => (_jsx(_Fragment, { children: props.children })));
ThemeContainer.displayName = "ThemeContainer";
export default function ThemeProvider({ children, isDark, }) {
    useEffect(() => {
    ...
    return (_jsx(CacheProvider, { value: muiCache, children: _jsx(MuiThemeProvider, { theme: muiTheme, children: children }) }));
}
