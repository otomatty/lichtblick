...
class Ros2LocalBagDataSourceFactory {
    ...
    iconName = "OpenFile";
    supportedFileTypes = [AllowedFileExtensions.DB3];
    ...
    initialize(args) {
        ...
        const source = new WorkerIterableSource({
            initWorker: () => {
                ...
                new URL("@lichtblick/suite-base/players/IterablePlayer/rosdb3/RosDb3IterableSourceWorker.worker", import.meta.url));
            },
            initArgs: { files },
        });
