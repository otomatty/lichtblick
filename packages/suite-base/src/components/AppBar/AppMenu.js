...
export function AppMenu(props) {
     ...
     */
    const handleItemPointerEnter = useCallback((id) => {
        setNestedMenu(id);
    }, []);
    ...
    const fileItems = useMemo(() => {
        const items = [
            ...
            },
            {
                ...
                onClick: () => {
                    handleNestedMenuClose();
                    dialogActions.openFile.open().catch((err) => {
                        console.error(err);
                    });
                },
            },
        ...
        recentSources.slice(0, 5).map((recent) => {
            items.push({
                ...
                label: _jsx(TextMiddleTruncate, { text: recent.title, className: classes.truncate }),
            });
        });
        return items;
    }, [
    ...
    return (_jsx(_Fragment, { children: _jsxs(Menu, { anchorEl: anchorEl, anchorReference: anchorReference, anchorPosition: anchorPosition, disablePortal: disablePortal, id: "app-menu", open: open, disableAutoFocusItem: true, onClose: handleNestedMenuClose, MenuListProps: {
            ...
            }, children: [_jsx(NestedMenuItem, { onPointerEnter: handleItemPointerEnter, items: fileItems, open: nestedMenu === "app-menu-file", id: "app-menu-file", children: t("file") }), _jsx(NestedMenuItem, { onPointerEnter: handleItemPointerEnter, items: viewItems, open: nestedMenu === "app-menu-view", id: "app-menu-view", children: t("view") }), _jsx(NestedMenuItem, { onPointerEnter: handleItemPointerEnter, items: helpItems, open: nestedMenu === "app-menu-help", id: "app-menu-help", children: t("help") })] }) }));
}
