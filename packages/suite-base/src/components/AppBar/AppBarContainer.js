 ...
 */
export function AppBarContainer(props) {
     ...
     */
    const extraStyle = useMemo(() => ({ paddingLeft: leftInset }), [leftInset]);
    /**
     * ダブルクリックイベントハンドラー
     *
    ...
    return (_jsx(MuiAppBar, { className: classes.root, style: extraStyle, position: "relative", color: "inherit", elevation: 0, onDoubleClick: handleDoubleClick, "data-tourid": "app-bar", children: children }));
}
