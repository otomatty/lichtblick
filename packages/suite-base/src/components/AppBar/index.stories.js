 ...
 */
export const DefaultChinese = { parameters: { forceLanguage: "zh" } };
/**
 ...
 */
export const DefaultJapanese = { parameters: { forceLanguage: "ja" } };
// ========================================
 ...
 */
export const CustomWindowControls = {
 ...
 */
export const CustomWindowControlsMaximized = {
 ...
 */
export const CustomWindowControlsDragRegion = {
 ...
 */
const Grid = (Story) => (_jsx(Stack, { overflowY: "auto", children: _jsx("div", { style: { display: "grid", gridTemplateColumns: "max-content auto", alignItems: "center" }, children: _jsx(Story, {}) }) }));
/**
...
export const PlayerStates = {
    decorators: [
        (Story) => {
            ...
            return (_jsx(_Fragment, { children: playerStates.map((props) => (_jsxs(MockMessagePipelineProvider, { name: props.name, presence: props.presence, alerts: props.alerts, children: [_jsx("div", { style: { padding: 8 }, children: props.label ?? props.presence }), _jsx("div", { children: _jsx(Story, {}) })] }, props.presence))) }));
        },
        Grid,
    ],
 ...
 */
export const PlayerStatesJapanese = {
    ...PlayerStates,
...
export const DataSources = {
    decorators: [
        (Story) => {
            ...
            return (_jsx(_Fragment, { children: playerStates.map((props) => (_jsxs(MockMessagePipelineProvider, { name: props.name, presence: PlayerPresence.PRESENT, urlState: props.urlState, alerts: props.alerts, seekPlayback: () => { }, children: [_jsx("div", { style: { padding: 8 }, children: props.label ?? props.urlState?.sourceId }), _jsx("div", { children: _jsx(Story, {}) })] }, props.urlState?.sourceId))) }));
        },
        Grid,
    ],
    parameters: { colorScheme: "light" },
 ...
 */
export const DataSourcesJapanese = {
    ...DataSources,
    parameters: { colorScheme: "light", forceLanguage: "ja" },
};
