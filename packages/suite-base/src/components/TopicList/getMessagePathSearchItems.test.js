...
describe("getMessagePathSearchItems", () => {
    ...
    it("supports cyclic types at root and non-root levels", () => {
        ...
        expect(getMessagePathSearchItems([{ name: "foo", schemaName: "Foo" }], schemasByName).items).toEqual([
            {
        ...
        expect(getMessagePathSearchItems([{ name: "bar", schemaName: "Bar" }], schemasByName).items).toEqual([
            {
                topic: { name: "bar", schemaName: "Bar" },
    ...
    it("includes quoted topic name length in offset", () => {
        ...
        expect(getMessagePathSearchItems([{ name: "foo with spaces", schemaName: "Foo" }], schemasByName)
            .items).toEqual([
            {
    ...
    it("works for foxglove.ImageAnnotations", () => {
        ...
        expect(getMessagePathSearchItems([{ name: "annotations", schemaName: "foxglove.ImageAnnotations" }], datatypes).items).toMatchInlineSnapshot(`
      [
        {
