...
function itemToString(topicListItem) {
...
describe("useTopicListSearch", () => {
    it("sorts topics with matches above matching paths", () => {
        ...
        const { result } = renderHook(() => useTopicListSearch({ topics, datatypes, filterText: "xyz" }));
    ...
    it("sorts better matches to the top", () => {
        ...
        const { result } = renderHook(() => useTopicListSearch({ topics, datatypes, filterText: "foobar" }));
    ...
    it("includes topic matches when there's a trailing dot", () => {
        ...
        const { result } = renderHook(() => useTopicListSearch({ topics, datatypes, filterText: "abc." }));
