...
const SidebarItems = (props) => {
    ...
    const { freeUser, teamOrEnterpriseUser } = useMemo(() => {
        const demoItem = {
            ...
            actions: (_jsxs(_Fragment, { children: [_jsx(Button, { onClick: () => {
                            onSelectView("demo");
                        ...
                        }, className: classes.button, variant: "outlined", children: t("exploreSampleData") }), _jsx(Button, { onClick: () => {
                            window.open(LICHTBLICK_DOCUMENTATION_LINK, "_blank", "noopener,noreferrer");
                        }, className: classes.button, variant: "outlined", children: t("viewDocumentation") })] })),
        };
        return {
            freeUser: [demoItem],
            teamOrEnterpriseUser: [
                demoItem,
                {
                    ...
                    actions: (_jsx(_Fragment, { children: _jsx(Button, { href: "https://foxglove.dev/tutorials", target: "_blank", className: classes.button, onClick: () => {
                                void analytics.logEvent(AppEvent.DIALOG_CLICK_CTA, {
                                    user: currentUserType,
                                    cta: "tutorials",
                                });
                            }, children: t("seeTutorials") }) })),
                },
            ],
        };
                ...
                return [
                    {
                        ...
                        actions: (_jsxs(_Fragment, { children: [_jsx(Button, { href: "https://console.foxglove.dev/recordings", target: "_blank", variant: "outlined", className: classes.button, onClick: () => {
                                        void analytics.logEvent(AppEvent.DIALOG_CLICK_CTA, {
                                            user: currentUserType,
                                            cta: "upload-to-dp",
                                        });
                                    }, children: t("uploadToDataPlatform") }), _jsx(Button, { href: "https://docs.foxglove.dev/docs/visualization/layouts#team-layouts", target: "_blank", className: classes.button, children: t("shareLayouts") })] })),
                    },
                    ...freeUser,
                ];
    ...
    return (_jsxs(Stack, { fullHeight: true, direction: "column", justifyContent: "space-between", children: [_jsx(Stack, { children: sidebarItems.map((item) => (_jsxs(Stack, { children: [_jsx(Typography, { variant: "h5", gutterBottom: true, children: item.title }), _jsx(Typography, { variant: "body2", color: "text.secondary", children: item.text }), item.actions != undefined && (_jsx(Stack, { direction: "row", flexWrap: "wrap", alignItems: "center", gap: 1, paddingTop: 1.5, children: item.actions }))] }, item.id))) }), _jsx(DontShowThisAgainCheckbox, {})] }));
};
