 ...
 * ```
 */
const DontShowThisAgainCheckbox = () => {
     ...
     */
    const [checked = true, setChecked] = useAppConfigurationValue(AppSetting.SHOW_OPEN_DIALOG_ON_STARTUP);
    /**
     * チェックボックス状態変更ハンドラー
     *
     ...
     * 邪魔にならないよう配慮されています。
     */
    const LabelComponent = _jsx("span", { style: { fontSize: "0.7rem" }, children: t("dontShowThisAgain") });
    return (_jsx(Stack, { direction: "row", justifyContent: "right", children: _jsx(FormControlLabel, { label: LabelComponent, control: _jsx(Checkbox, { size: "small", checked: !checked, onChange: handleChange }) }) }));
};
