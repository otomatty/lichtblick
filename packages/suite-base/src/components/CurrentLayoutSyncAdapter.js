...
const EMPTY_UNSAVED_LAYOUTS = {};
const SAVE_INTERVAL_MS = 1000;
const selectCurrentLayout = (state) => state.selectedLayout;
/**
 * Observes changes in the current layout and asynchronously pushes them to the
 * layout manager.
 */
export function CurrentLayoutSyncAdapter() {
    ...
    const [debouncedUnsavedLayouts, debouncedUnsavedLayoutActions] = useDebounce(unsavedLayouts, SAVE_INTERVAL_MS);
