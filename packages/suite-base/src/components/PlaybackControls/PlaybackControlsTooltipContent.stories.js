...
function Wrapper(Wrapped) {
    ...
    return (_jsx(TimelineInteractionStateProvider, { children: _jsx(MockMessagePipelineProvider, { children: _jsx("div", { style: {
                    maxWidth: "16rem",
                    marginInline: "auto",
...
export const Default = {
    render: () => {
        return _jsx(PlaybackControlsTooltipContent, { stamp: { sec: 1, nsec: 1 } });
    },
};
            ...
            setEvents([
                {
                    event: {
                        ...
                        metadata: {
                            "meta 1": "value 1",
                            "meta 2": "value 2",
                            "long event metadata key that might overflow": "long event metadata value that might also overflow",
                        },
