...
export default function PlaybackBarHoverTicks(props) {
    ...
    return (_jsx(Stack, { ref: ref, flex: "auto", children: scaleBounds && (_jsx(HoverBar, { componentId: componentId, scales: scaleBounds, isPlaybackSeconds: true, children: _jsx(Tooltip, { arrow: true, classes: { popper: classes.tooltip }, placement: "top", disableFocusListener: true, disableHoverListener: true, disableTouchListener: true, disableInteractive: true, TransitionProps: { timeout: 0 }, open: displayHoverTime, title: _jsx("div", { className: classes.time, children: hoverTimeDisplay }), children: _jsx("div", { className: classes.tick }) }) })) }));
}
