...
import { isLessThan, subtract as subtractTimes, toSec } from "@lichtblick/rostime";
        ...
        if (this.#lastMessages !== messages || this.#lastCurrentTime !== currentTime) {
            ...
            for (const message of messages) {
                    ...
                    if (currentTimeDrift > DRIFT_THRESHOLD_SEC) {
                        ...
                        if (!this.#warningTimeout) {
                            ...
                            this.#warningTimeout = setTimeout(() => {
                                ...
                                this.#incorrectMessages = [];
                                log.warn(`Message receiveTime very different from player.currentTime; without updating lastSeekTime`, info);
                ...
                if (this.#lastMessageTime &&
                    ...
                    const errorMessage = `Processed a message on ${message.topic} at ${formattedTime} which is earlier than ` +
