...
export default class PanelErrorBoundary extends Component {
    ...
    render() {
        ...
        if (this.state.currentError) {
            return (_jsx(ErrorDisplay, { title: "This panel encountered an unexpected error", error: this.state.currentError.error, errorInfo: this.state.currentError.errorInfo, showErrorDetails: this.props.showErrorDetails, hideErrorSourceLocations: this.props.hideErrorSourceLocations, content: _jsxs("p", { children: ["Something went wrong in this panel.", " ", _jsx(Link, { color: "inherit", onClick: () => {
                                // エラーを無視して継続使用
                                this.setState({ currentError: undefined });
                            }, children: "Dismiss this error" }), " ", "to continue using this panel. If the issue persists, try resetting the panel."] }), actions: _jsx(_Fragment, { children: _jsxs(Stack, { direction: "row-reverse", gap: 1, children: [_jsx(Button, { variant: "outlined", color: "secondary", onClick: () => {
                                    this.setState({ currentError: undefined });
                                }, children: "Dismiss" }), _jsx(Button, { variant: "outlined", title: "Reset panel settings to default values", color: "error", onClick: () => {
                                    // エラー状態をクリアしてパネルをリセット
                                    this.setState({ currentError: undefined });
                                    this.props.onResetPanel();
                                }, children: "Reset Panel" }), _jsx(Button, { variant: "text", title: "Remove this panel from the layout", color: "error", onClick: this.props.onRemovePanel, children: "Remove Panel" })] }) }) }));
        }
