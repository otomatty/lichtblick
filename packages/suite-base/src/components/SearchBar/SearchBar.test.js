...
describe("SearchBar component", () => {
    ...
    it("renders with default props", () => {
        render(_jsx(SearchBar, { value: "", onChange: mockOnChange }));
        const input = screen.getByTestId("SearchBarComponent");
        expect(input).toBeInTheDocument();
        expect(screen.getByTestId("SearchIcon")).toBeInTheDocument();
    });
    it("renders with clear icon when showClearIcon is true", () => {
        render(_jsx(SearchBar, { value: BasicBuilder.string(), onChange: mockOnChange, onClear: mockOnClear, showClearIcon: true }));
    ...
    it("does not render clear icon when showClearIcon is false", () => {
        render(_jsx(SearchBar, { value: BasicBuilder.string(), onChange: mockOnChange, showClearIcon: false }));
