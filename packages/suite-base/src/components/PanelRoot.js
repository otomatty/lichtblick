 ...
 * @since 2023
 */
export const PanelRoot = forwardRef(function PanelRoot(props, ref) {
    const { className, fullscreenState, hasFullscreenDescendant, selected, sourceRect, ...rest } = props;
    ...
    return (_jsx("div", { ref: ref, className: classNames, ...rest, children: props.children }));
});
