...
describe("NewSidebar", () => {
    function buildSidebarItem(props = {}) {
        ...
        return {
            title,
            component: () => _jsxs("div", { children: ["Component of ", title] }),
            ...props,
        };
    }
    ...
    const renderComponent = (propsOverride = {}) => {
        ...
        const ui = _jsx(NewSidebar, { ...props });
        ...
        return {
            ...
            sidebarItems,
            tabs,
            rerender: (newPropsOverride = {}) => {
                renderObj.rerender(_jsx(NewSidebar, { ...props, ...newPropsOverride }));
            },
        };
    };
    ...
    it("should render the badge content", () => {
        ...
        const key = "withBadge";
        items.set(key, buildSidebarItem({
            badge: {
    ...
    it("should change tabs when setActiveTab is called", () => {
        let newActiveTab = "";
        const setActiveTab = jest.fn((tab) => {
            newActiveTab = tab;
        });
