...
const PanelToolbarControlsComponent = forwardRef((props, ref) => {
    ...
    const hasSettingsSelector = useCallback((store) => (panelId ? store.settingsTrees[panelId] != undefined : false), [panelId]);
    ...
    return (_jsxs(Stack, { direction: "row", alignItems: "center", paddingLeft: 1, ref: ref, children: [additionalIcons, showSettingsButton && (_jsx(ToolbarIconButton, { title: "Settings", onClick: openSettings, children: _jsx(SettingsIcon, {}) })), _jsx(PanelActionsDropdown, { isUnknownPanel: isUnknownPanel })] }));
});
