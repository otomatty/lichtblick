...
function DropOverlay(props) {
    ...
    return (_jsx(Dialog, { fullScreen: true, open: props.open, style: { zIndex: 10000000 }, classes: { paperFullScreen: classes.outer }, children: _jsx("div", { className: classes.inner, children: _jsx(Typography, { variant: "h1", align: "center", children: props.children }) }) }));
}
