...
jest.mock("@lichtblick/suite-base/components/ExtensionDetails", () => ({
    ExtensionDetails: ({ extension, onClose }) => {
        return (_jsxs("div", { "data-testid": "mock-extension-details", children: [_jsx("p", { children: extension.name }), _jsx("button", { "data-testid": "mockCloseExtension", onClick: onClose, children: "Close" })] }));
    },
}));
describe("ExtensionsSettings", () => {
    ...
    function setUpHook(props) {
        useExtensionSettings.mockReturnValue({
    ...
    it("renders the search bar and three extension lists", () => {
        render(_jsx(ExtensionsSettings, {}));
