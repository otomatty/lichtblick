...
describe("ExtensionListEntry Component", () => {
    const mockEntry = ExtensionBuilder.extensionMarketplaceDetail();
    const mockOnClick = jest.fn();
    it("renders primary text with name and highlights search text", () => {
        render(_jsx(ExtensionListEntry, { entry: mockEntry, searchText: mockEntry.name, onClick: mockOnClick }));
    ...
    it("calls onClick when ListItemButton is clicked", () => {
        render(_jsx(ExtensionListEntry, { entry: mockEntry, searchText: "", onClick: mockOnClick }));
