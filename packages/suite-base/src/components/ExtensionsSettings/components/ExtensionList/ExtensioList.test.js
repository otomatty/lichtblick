...
import ExtensionList, { displayNameForNamespace, generatePlaceholderList, } from "@lichtblick/suite-base/components/ExtensionsSettings/components/ExtensionList/ExtensionList";
...
describe("ExtensionList Component", () => {
    ...
    it("renders the list of extensions correctly", () => {
        render(_jsx(ExtensionList, { namespace: mockNamespace, entries: mockEntries, filterText: mockFilterText, selectExtension: mockSelectExtension }));
    ...
    it("renders 'No extensions found' message when entries are empty and there's filterText", () => {
        ...
        render(_jsx(ExtensionList, { namespace: mockNamespace, entries: emptyMockEntries, filterText: randomSearchValue, selectExtension: mockSelectExtension }));
    ...
    it("renders 'No extensions available' message when entries are empty", () => {
        render(_jsx(ExtensionList, { namespace: mockNamespace, entries: emptyMockEntries, filterText: "", selectExtension: mockSelectExtension }));
    ...
    it("calls selectExtension with the correct parameters when an entry is clicked", () => {
        render(_jsx(ExtensionList, { namespace: mockNamespace, entries: mockEntries, filterText: "", selectExtension: mockSelectExtension }));
