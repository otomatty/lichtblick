...
const SelectValidWithUndefinedSettings = {
    general: {
        fields: {
...
const SelectValidWithEmptyStringSettings = {
    general: {
        fields: {
...
const SelectInvalidWithUndefinedSettings = {
    general: {
        fields: {
...
const SelectInvalidWithoutUndefinedSettings = {
    general: {
        fields: {
...
const SelectEmptyInvalidSettings = {
    general: {
        fields: {
            invalidEmptySelect: {
...
function updateSettingsTreeNodes(previous, path, value) {
    const workingPath = [...path];
    return produce(previous, (draft) => {
        let node = draft[workingPath[0]];
        workingPath.shift();
...
function makeBackgroundNode(index) {
    return {
...
function Wrapper({ nodes }) {
    ...
    const actionHandler = useCallback((action) => {
        ...
        setSettingsNodes((previous) => updateSettingsTreeNodes(previous, action.payload.path, action.payload.value));
    }, [dynamicNodes]);
    ...
    useEffect(() => {
        setSettingsNodes(produce((draft) => {
            if ("general" in draft) {
                draft.general.children = dynamicNodes;
            }
        }));
    }, [dynamicNodes]);
    return (_jsx(PanelSetup, { fixture: MessagePathInputStoryFixture, children: _jsx(Stack, { fullWidth: true, overflow: "auto", style: { background: theme.palette.background.paper }, children: _jsx(SettingsTreeEditor, { variant: "panel", settings: settingsTree }) }) }));
}
export const Basics = {
    render: function Story() {
        return _jsx(Wrapper, { nodes: BasicSettings });
    },
...
export const BasicsChinese = {
    ...Basics,
    parameters: { forceLanguage: "zh" },
};
export const BasicsJapanese = {
    ...Basics,
    parameters: { forceLanguage: "ja" },
};
export const DisabledFields = {
    render: () => {
        return _jsx(Wrapper, { nodes: DisabledSettings });
    },
};
export const ReadonlyFields = {
    render: () => {
        return _jsx(Wrapper, { nodes: ReadonlySettings });
    },
};
export const PanelExamples = {
    render: function Story() {
        return _jsx(Wrapper, { nodes: PanelExamplesSettings });
    },
    play: async ({ canvasElement }) => {
...
export const IconExamples = {
    render: () => {
        return _jsx(Wrapper, { nodes: IconExamplesSettings });
    },
};
export const Topics = {
    render: () => {
        return _jsx(Wrapper, { nodes: TopicSettings });
    },
};
export const Filter = {
    render: function Story() {
        return _jsx(Wrapper, { nodes: FilterSettings });
    },
    play: async ({ canvasElement }) => {
        const canvas = within(canvasElement);
...
export const Colors = {
    render: () => {
        return _jsx(Wrapper, { nodes: ColorSettings });
    },
};
...
export const SetHiddenValueToTrue = {
    render: () => {
        return _jsx(Wrapper, { nodes: ColorSettings });
    },
};
export const Vec2 = {
    render: () => {
        ...
        return _jsx(Wrapper, { nodes: settings });
    },
};
export const Vec3 = {
    render: () => {
...
export const SelectInvalidWithUndefined = {
    render: function Story() {
        return _jsx(Wrapper, { nodes: SelectInvalidWithUndefinedSettings });
    },
    play: clickSelect,
};
export const SelectInvalidWithoutUndefined = {
    render: function Story() {
        return _jsx(Wrapper, { nodes: SelectInvalidWithoutUndefinedSettings });
    },
    play: clickSelect,
};
export const SelectValidWithUndefined = {
    render: function Story() {
        return _jsx(Wrapper, { nodes: SelectValidWithUndefinedSettings });
    },
    play: clickSelect,
};
export const SelectValidWithEmptyString = {
    render: function Story() {
        return _jsx(Wrapper, { nodes: SelectValidWithEmptyStringSettings });
    },
    play: clickSelect,
};
export const SelectEmpty = {
    render: function Story() {
        return _jsx(Wrapper, { nodes: SelectEmptySettings });
    },
    play: clickSelect,
};
export const SelectEmptyInvalid = {
    render: function Story() {
        return _jsx(Wrapper, { nodes: SelectEmptyInvalidSettings });
    },
    play: clickSelect,
};
