...
describe("<DocumentDropListener>", () => {
    ...
    beforeEach(() => {
        ...
        root.render(_jsx("div", { children: _jsx(SnackbarProvider, { children: _jsx(ThemeProvider, { isDark: false, children: _jsx(DocumentDropListener, { allowedExtensions: [] }) }) }) }));
