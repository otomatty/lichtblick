...
export default {
    ...
    decorators: [
        (Story) => {
            ...
            return (_jsx(WorkspaceContextProvider, { children: _jsx("div", { style: { height: "100%", background: theme.palette.background.paper }, children: _jsx(AlertsContextProvider, { children: _jsx(Story, {}) }) }) }));
        },
    ],
};
...
export const Default = {
    render: function Story() {
        return (_jsx(MockMessagePipelineProvider, { startTime: START_TIME, endTime: END_TIME, presence: PlayerPresence.INITIALIZING, children: _jsx(AlertsList, {}) }));
    },
};
...
export const WithErrors = {
    render: function Story() {
        return (_jsx(MockMessagePipelineProvider, { startTime: START_TIME, endTime: END_TIME, topics: TOPICS, presence: PlayerPresence.RECONNECTING, alerts: makeAlerts(), children: _jsx(AlertsList, {}) }));
    },
};
export const WithErrorsChinese = {
    ...WithErrors,
    parameters: { forceLanguage: "zh" },
};
export const WithErrorsJapanese = {
    ...WithErrors,
    parameters: { forceLanguage: "ja" },
};
export const WithSessionAlerts = {
    render: function Story() {
        ...
        return (_jsx(MockMessagePipelineProvider, { startTime: START_TIME, endTime: END_TIME, topics: TOPICS, presence: PlayerPresence.RECONNECTING, alerts: makeAlerts(), children: _jsx(WorkspaceContextProvider, { children: _jsx(AlertsList, {}) }) }));
    },
};
