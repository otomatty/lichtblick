 ...
 * ```
 */
declare const PanelContext: import("react").Context<PanelContextType<PanelConfig> | undefined>;
/**
 ...
 */
export declare function usePanelContext(): PanelContextType<PanelConfig>;
