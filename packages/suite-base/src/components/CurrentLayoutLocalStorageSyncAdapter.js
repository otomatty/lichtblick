...
function selectLayoutData(state) {
    return state.selectedLayout?.data;
}
const log = Log.getLogger(__filename);
export function CurrentLayoutLocalStorageSyncAdapter() {
    ...
    useEffect(() => {
        ...
        const layoutData = migratePanelsState(serializedLayoutData ? JSON.parse(serializedLayoutData) : defaultLayout);
