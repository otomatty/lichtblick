...
export function StudioLogsSettings() {
    const logSettings = useStudioLogsSettingsTree();
    return _jsx(SettingsTreeEditor, { variant: "log", settings: logSettings });
}
export function StudioLogsSettingsSidebar() {
    return (_jsx(SidebarContent, { overflow: "auto", title: "Studio Logs Settings", disablePadding: true, children: _jsx(StudioLogsSettings, {}) }));
}
