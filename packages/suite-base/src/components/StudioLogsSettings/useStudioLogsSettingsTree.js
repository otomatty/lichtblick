...
function useStudioLogsSettingsTree() {
    ...
    return useMemo(() => {
        ...
        const itemDetailByPath = new Map();
        ...
        // prod.
        const disableIndividualOverride = logsConfig.globalLevel === "warn" || logsConfig.globalLevel === "error";
