...
export default function TextContent(props) {
    ...
    const linkRenderer = useCallback((linkProps) => {
        return (_jsx(Link, { color: "primary", underline: "hover", variant: "inherit", href: linkProps.href, rel: "noopener noreferrer", onClick: (event) => {
                handleLink(event, linkProps.href ?? "");
            }, target: "_blank", children: linkProps.children }));
    }, [handleLink]);
    return (_jsx("div", { className: classes.root, style: style, children: typeof children === "string" ? (_jsx(Markdown, { rehypePlugins: allowMarkdownHtml === true ? [rehypeRaw] : [], components: { a: linkRenderer }, children: children })) : (children) }));
}
