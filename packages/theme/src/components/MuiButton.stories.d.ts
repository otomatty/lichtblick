...
declare const _default: {
    ...
    decorators: ((Story: import("@storybook/core/csf").PartialStoryFn<import("@storybook/react/dist/types-5617c98e").R, {
        ...
        color?: import("@mui/types").OverridableStringUnion<"success" | "info" | "warning" | "error" | "inherit" | "primary" | "secondary", import("@mui/material").ButtonPropsColorOverrides> | undefined;
...
export declare const TextButton: StoryObj;
export declare const ContainedButton: StoryObj;
export declare const DisableElevation: StoryObj;
export declare const OutlinedButton: StoryObj;
export declare const Color: StoryObj;
export declare const Sizes: StoryObj;
export declare const ButtonsWithIcons: StoryObj;
